...
<div class="flex items-center space-x-6 text-[#154212]">
                <a href="#cart" class="hover:scale-105 transition-all duration-300 ease-out relative">
                    ...
                    <?php if(session()->has('cart') && count(session('cart')) > 0): ?>
                        <span class="absolute -top-2 -right-2 bg-error text-white text-xs rounded-full w-6 h-6 flex items-center justify-center font-bold text-sm"><?php echo e(count(session('cart'))); ?></span>
                    <?php endif; ?>
                </a>
            ...
            <?php echo $__env->make('partials.cart-sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </nav>
