...
<?php $__env->startSection('title', 'Home - Nugie Skincare & Herbal SR12'); ?>
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-8 w-full">
        <div class="max-w-2xl space-y-6">
            ...
            <div class="flex items-center space-x-4 pt-4">
                <a href="<?php echo e(route('products.index')); ?>" class="editorial-gradient text-white px-8 py-3 rounded-xl font-semibold hover:shadow-lg transition-all duration-300">
                    Jelajahi Katalog
                </a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Soutprint.ln\Nugie sr12\resources\views/pages/home.blade.php ENDPATH**/ ?>